...
| `/admin/cycles/[cycleKey]/prep` | Internal operators | Read-only prep and exception review workspace for locked cycle manifests. | Session 23 added blocker/warning review on top of the immutable lock manifest before calculation packaging. | finish | Operator monthly cycle prep workspace | 23, 24, 25 |
