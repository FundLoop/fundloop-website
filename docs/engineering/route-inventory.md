...
| `/admin/cycles/[cycleKey]/verification` | Internal operators | Cycle-level cleanup, verification, and approval workspace. | Session 26 added result-total checks, cleanup-needed decisions, verified-cycle review, and approval for distribution. | finish | Operator monthly cycle verification workspace | 26, 27 |
