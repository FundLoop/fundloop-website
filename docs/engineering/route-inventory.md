...
| `/admin/cycles` | Internal operators | Read-only monthly cycle overview. | Session 21 added first-class economic month records and linked payment/reconciliation/zkAS summaries here. | finish | Operator monthly cycle workspace | 21, 22, 36 |
