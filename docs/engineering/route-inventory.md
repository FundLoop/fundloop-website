...
| `/founder/projects/[slug]/attribution` | Founders, project members | Founder-facing contribution-data workflow. | Session 34 exposes the structured zkAS dataset contract, recent submission validation/approval state, and links into the current upload/detail routes without duplicating dataset writes. | finish | Founder project attribution workflow | 34 |
