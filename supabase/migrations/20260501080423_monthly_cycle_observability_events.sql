...
CREATE INDEX IF NOT EXISTS idx_monthly_cycle_events_outcome_created
ON public.monthly_cycle_events (outcome, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_monthly_cycle_events_type_created
ON public.monthly_cycle_events (event_type, created_at DESC);
