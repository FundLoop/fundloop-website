  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col items-end select-none">
      <div
        ...
        } relative w-80 max-w-[calc(100vw-2.5rem)] flex-col rounded-2xl border border-amber-500/40 bg-neutral-950/95 p-5 text-neutral-100 shadow-2xl backdrop-blur-xl animate-in fade-in zoom-in-95 duration-200`}
      >
        {/* Header */}
