...
export function FounderRuntimeMoatMathPanel({
  ...
  return (
    <div className="rounded-[2.5rem] border border-[color:var(--marketing-line)] bg-[linear-gradient(145deg,rgba(255,248,238,0.92),rgba(244,203,141,0.18))] p-6 shadow-[0_28px_90px_rgba(15,23,23,0.1)] dark:bg-[linear-gradient(145deg,rgba(14,24,23,0.96),rgba(239,139,87,0.09))] sm:p-10 lg:p-12">
      ...
      <div className="mt-10 grid gap-6 rounded-3xl border border-[color:var(--marketing-line)] bg-white/60 p-6 dark:bg-white/[0.03] md:grid-cols-3">
        {/* Slider 1: MAU */}
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-2">
        ...
        {/* FundLoop Model */}
        <div className="relative rounded-[2rem] border-2 border-emerald-500/50 bg-white/80 p-6 shadow-xl dark:bg-black/40 sm:p-8">
          <div className="absolute -top-3.5 right-6 rounded-full bg-emerald-600 px-3.5 py-1 text-[0.65rem] font-bold uppercase tracking-widest text-white">
            Compound Moat
          </div>
      ...
      <div className="mt-10 grid gap-5 md:grid-cols-3">
        <div className="rounded-[1.75rem] border border-[color:var(--marketing-line)] bg-white/60 p-6 dark:bg-white/[0.03]">
