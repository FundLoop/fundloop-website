    ...
    <MarketingPage>
      ...
      {epochClose ? <MarketingSection className="pt-0">
        <Reveal><EpochCloseSummaryCard
          ...
          rootHash={epochClose.root_hash ?? ""}
          values={[
            {label:"Funded minor",value:String(epochClose.funded_minor ?? 0)},
            ...
            {label:"Sources",value:String(epochClose.source_count ?? 0)},{label:"Stage",value:epochClose.status ?? "payout_readying"},
          ]}
        /></Reveal>
