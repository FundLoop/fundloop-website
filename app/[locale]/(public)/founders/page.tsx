        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.06fr)_minmax(22rem,0.94fr)]">
          <Reveal>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                <a href="#growth-math">{t("hero.secondaryCta")}</a>
              </Button>
            </div>
          </Reveal>
        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-[2.5rem] border border-[color:var(--marketing-line)] bg-white/70 p-4 shadow-xl dark:border-white/[0.1] dark:bg-white/[0.03] sm:p-6 lg:p-8">
            ...
            <div className="mt-6 flex flex-col justify-between gap-4 px-2 sm:flex-row sm:items-center">
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-[var(--marketing-accent)]">{t("dashboardShowcase.eyebrow")}</p>
                <h3 className="font-display text-2xl font-bold tracking-tight text-[var(--marketing-ink)]">{t("dashboardShowcase.title")}</h3>
              </div>
              <p className="max-w-md text-xs leading-relaxed text-[var(--marketing-muted-strong)]">
                {t("dashboardShowcase.body")}
              </p>
            </div>
          </div>
        </Reveal>
      ...
      <MarketingSection className="pb-24">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2.5rem] border border-[color:var(--marketing-line)] bg-white/55 p-4 shadow-xl dark:border-white/[0.1] dark:bg-white/[0.03]">
            <div className="relative aspect-[16/9] w-full overflow-hidden rounded-[2rem] bg-neutral-100 dark:bg-neutral-900">
              <Image
                src="/images/marketing/fundloop-for-projects.png"
                alt={t("bannerAlt")}
                fill
                className="object-cover object-center"
                sizes="(max-width: 1200px) 100vw, 1200px"
