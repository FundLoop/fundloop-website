...
create table public.participants (
  ...
  constraint user_project_participation_pkey primary key (project_id, user_id),
  constraint participants_id_key unique (id),
  constraint user_project_participation_project_id_fkey foreign KEY (project_id) references projects (id),
...
create table public.participant_roles (
  ...
  created_at timestamp with time zone not null default now(),
  constraint participant_roles_pkey primary key (participant_id, role_id),
  constraint participant_roles_participant_id_fkey foreign KEY (participant_id) references participants (id),
  constraint participant_roles_role_id_fkey foreign KEY (role_id) references ref_roles (id)
) TABLESPACE pg_default;
...
create table public.users (
 ...
 signup_step integer null default 1,
 signin_count integer null default 0,
